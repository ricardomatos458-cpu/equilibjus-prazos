-- ============================================================
-- EQUILIBJUS Prazos — Schema Supabase
...
-- Politicas para uso com chave anonima (acesso interno, sem autenticacao)
-- Ajuste ou remova conforme o modelo de seguranca do seu projeto
...
-- ============================================================
-- Dados de exemplo (opcional — remova antes de ir para producao)
-- ============================================================
/*
